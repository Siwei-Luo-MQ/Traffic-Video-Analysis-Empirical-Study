...
def message_template(video_path, total_pixels, min_pixels, fps):
    ...
    It is known that the resolution of the video is 640*480 and the FPS is 25."""
    ...
    messages = [
        ...
        {"role": "user", "content": [
            ...
            {"video": video_path_1, "total_pixels": total_pixels, "min_pixels": min_pixels, 'fps': fps},
        ]
         },
        {"role": "assistant",
         "content": ass_input_1
        ...
        {"role": "user", "content": [
            ...
            {"video": video_path_2, "total_pixels": total_pixels, "min_pixels": min_pixels, 'fps': fps},
        ]
         },
        {"role": "assistant",
         "content": ass_input_2
        ...
        {"role": "user", "content": [
            ...
            {"video": video_path, "total_pixels": total_pixels, "min_pixels": min_pixels, 'fps': fps},
        ]
         }
    ]
    return messages
...
def evaluation(dataset, model, processor, args):
    ...
    for instance in dataset:
        ...
        # prepare message
        messages = message_template(video_path, args.total_pixels, args.min_pixels, args.fps)
...
def main():
    ...
    parser.add_argument('--fps',
                        default=25.0, # So-TAD is recorded in 25 FPS
                        help='Video FPS')
